...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> loginAction() async {
    ...
    try {
      ...
      log(credentials.accessToken);
//
//       final Credentials credentials = await auth0.webAuthentication(scheme: appScheme).login(useHTTPS: true);
// print("credentials:${credentials.accessToken}");
  ...
  Future<void> logoutAction() async {
    var response = await auth0.webAuthentication(scheme: appScheme).logout();
